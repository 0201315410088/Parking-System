...
public class CityNewSlot
{
    ...
    public ICollection<CityNewBooking> Bookings { get; set; } = new List<CityNewBooking>();
...
public class CityNewBooking
{
    ...
    [Required]
    public CityCarType CityCarType { get; set; }
    ...
    // Navigation property
    public CityNewSlot Slot { get; set; } // References the Slot
    ...
    public static bool IsOverlapping(DateTime startTime, DateTime endTime, List<CityNewBooking> existingBookings) =>
...
public class CityBookingViewModel
{
    public int BookingId { get; set; }
    public int SlotId { get; set; }
    public DateTime BookingTime { get; set; } = DateTime.UtcNow.AddHours(2);
    ...
    public CityCarType CityCarType { get; set; } // Added CarType property
...
public class CityTransactionHistory
{
    [Key]
    [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
...
public class CityProfileTransactionViewModel
{
    public Profile Profile { get; set; }
    public CityTransactionHistory CityTransactionHistory { get; set; }

}

public class CityCarImageBookingViewModel
{
    public CityBookingViewModel CityBookingViewModel { get; set; }
